...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        model.load_state_dict(new_state_dict, strict=False)  # loads
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/shen2/zhb/yolov5l_share_ssf/yolov5l.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_MultiDSwin_FLIR.yaml', help='model.yaml path')
